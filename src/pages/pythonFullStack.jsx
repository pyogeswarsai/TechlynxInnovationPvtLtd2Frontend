...
const faqs = [
  {
    question: "What is a Python Full-Stack Developer course?",
    answer:
      "This course trains you in both frontend (HTML, CSS, JavaScript, React) and backend (Python, Django/Flask) development, along with databases and deployment skills.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic knowledge of programming is helpful but not required. The course usually begins with Python fundamentals before advancing to full-stack concepts.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You will learn HTML, CSS, JavaScript, React for frontend, Python with Django/Flask for backend, REST APIs, MySQL/MongoDB for databases, and Git/GitHub for version control.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build real-world projects like e-commerce websites, portfolio platforms, RESTful APIs, and full-stack applications to showcase in your resume.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Full-Stack Developer, Backend Developer, Frontend Developer, Web Application Developer, or Software Engineer in IT companies and startups.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive an industry-recognized certificate validating your full-stack development skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, many programs include career guidance, resume building, interview prep, and job referrals through hiring partners.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "Python basics, data types, loops, functions, OOP concepts, and problem-solving with mini exercises.",
    },
    {
    ...
    },
    {
      ...
      details:
        "Master Django/Flask, build REST APIs with authentication, perform CRUD operations, and follow MVC/MVT patterns.",
    },
    {
      title: "Module 4: Databases",
      details:
        "Work with MySQL/PostgreSQL for SQL, MongoDB for NoSQL, and practice joins, indexing, and optimization.",
    },
    {
      title: "Module 5: Version Control & Collaboration",
      details:
        "Learn Git basics, GitHub/GitLab workflows, branching, merging, pull requests, and open-source contributions.",
    },
    {
      title: "Module 6: Deployment & DevOps Basics",
      details:
        "Deploy apps using Docker, Nginx, Heroku, and set up CI/CD pipelines with GitHub Actions or Jenkins.",
    },
    {
      title: "Module 7: Advanced Tools",
      details:
        "Practice Postman for API testing, use Redis for caching, WebSockets for real-time apps, and security fundamentals.",
    },
    {
      title: "Module 8: Projects",
      details:
        "Build real-world portfolio projects: Blog App, E-commerce Store, Job Portal, and Real-time Chat App.",
    },
    {
      title: "Module 9: Career Preparation",
      details:
        "Prepare for jobs with system design basics, DSA revision, mock interviews, resume building, and communication skills.",
    },
  ];
      ...
      <div>
        ...
        <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
          <h3 className="fw-bold display-5">
            Advanced Certification in Full Stack Python Development
          </h3>
        ...
        <div className="container my-5">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center">
              <img
                src="https://www.vagdevitechnologies.com/wp-content/uploads/2025/02/Python-Full-Stack-image.jpg"
      ...
      <footer className="footer py-4">
        <div className="container text-center">
          ...
          <div className="footer-icons d-flex justify-content-center gap-4">
            <a href="https://www.facebook.com/people/Techlynx-Innovations/61579158831359/" className="facebook">
              <FaFacebookF />
            </a>
            <a href="https://x.com/TechlynxLimited" className="twitter">
              <FaXTwitter />
            </a>
            <a href="https://www.youtube.com/@techlynxinnovationsprivatelimi" className="youtube">
              <FaYoutube />
            </a>
            <a href="https://www.linkedin.com/in/nagul-meera-shaik-0b8650379/" className="linkedin">
              <FaLinkedinIn />
            </a>
            <a href="https://www.instagram.com/techlynxinnovations/" className="instagram">
              <FaInstagram />
            </a>
          </div>
        </div>
