...
const faqs = [
  {
    question: "What is Selenium Automation Testing?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, basic knowledge of Java, Python, or C# is recommended to write and maintain Selenium test scripts.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You’ll learn Selenium WebDriver, TestNG/JUnit for test management, Maven for build automation, Jenkins for CI/CD, and reporting tools like Allure.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "Projects include automating e-commerce sites, form submission, cross-browser testing, API testing with Postman, and CI/CD pipelines with Jenkins.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a QA Automation Engineer, Software Tester, SDET (Software Development Engineer in Test), or Test Analyst.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive a certificate validating your Selenium automation testing skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, the course provides career support, mock interviews, resume building, and job opportunities with IT companies.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "Introduction to manual testing concepts, SDLC, STLC, defect lifecycle, and test case design.",
    },
    {
      title: "Module 2: Java/Python for Test Automation",
      details:
        "Learn programming basics, OOP concepts, and scripting required for Selenium automation.",
    },
    {
      title: "Module 3: Selenium WebDriver Basics",
      details:
        "Setup Selenium, browser drivers, automate web elements (buttons, inputs, dropdowns).",
    },
    {
      title: "Module 4: Test Frameworks (TestNG/JUnit)",
      details:
        "Write structured test cases, assertions, annotations, test suites, and reports.",
    },
    {
      title: "Module 5: Advanced Selenium Features",
      details:
        "Handle alerts, frames, windows, waits, data-driven testing, and Page Object Model (POM).",
    },
    {
      title: "Module 6: Build & CI/CD Tools",
      details:
        "Use Maven for dependency management, integrate Jenkins for continuous testing.",
    },
    {
      title: "Module 7: API & Database Testing",
      details:
        "Test REST APIs with Postman, validate responses, and perform DB validations with SQL.",
    },
    {
      title: "Module 8: Reporting & Debugging",
      details:
        "Generate reports using Allure/Extent Reports, debug test failures, and maintain logs.",
    },
    {
      title: "Module 9: Career Preparation",
      details:
        "Prepare for QA roles, practice interview questions, build portfolio projects, and resume tips.",
    },
  ];
  return (
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification in Selenium
        </h3>
      ...
      <div className="container my-5">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            ...
            <h2 className="fw-bold">Advanced Certification in Selenium</h2>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 mb-4">
            <div className="certificate-card p-4 rounded shadow-lg">
              ...
              <h5 className="mt-4 text-success fw-bold">Selenium</h5>
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              Upon successful completion of our <strong>Selenium</strong>{" "}
