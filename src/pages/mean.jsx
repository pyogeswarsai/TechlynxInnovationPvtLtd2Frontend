...
const faqs = [
  {
    question: "What is a MEAN Stack Developer course?",
    answer:
      "This course trains you in full-stack web development using MongoDB, Express.js, Angular, and Node.js to build scalable applications.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic knowledge of programming helps but is not mandatory. The course usually begins with JavaScript fundamentals before moving into MEAN stack concepts.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You will learn HTML, CSS, JavaScript, Angular for frontend, Node.js & Express.js for backend, MongoDB for databases, REST APIs, and Git/GitHub for version control.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build projects like an E-commerce Application, Social Media Platform, Task Management System, Chat Application, and REST API-based applications.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a MEAN Stack Developer, Full-Stack Developer, Backend Developer, Frontend Developer, or Web Application Developer in startups and IT companies.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive an industry-recognized certificate validating your MEAN stack development skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, most programs offer career support including resume building, interview preparation, and job referrals with hiring partners.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "JavaScript basics, ES6+ features, data types, loops, functions, OOP concepts (classes, inheritance, polymorphism), asynchronous programming, and problem-solving exercises.",
    },
    {
      title: "Module 2: Front-End Development",
      details:
        "Learn HTML, CSS, JavaScript, responsive design with Bootstrap/Tailwind, and Angular framework for building interactive and dynamic user interfaces.",
    },
    {
      title: "Module 3: Back-End Development",
      details:
        "Master Node.js and Express.js for building RESTful APIs, authentication, CRUD operations, middleware, and following MVC architecture.",
    },
    {
      title: "Module 4: Databases",
      details:
        "Work with MongoDB as a NoSQL database, practice schema design, indexing, aggregation pipelines, and optimize queries for performance.",
    },
    {
    ...
    },
    {
      ...
      details:
        "Deploy MEAN applications using Docker, Nginx, and cloud platforms like AWS/Heroku, and set up CI/CD pipelines with Jenkins or GitHub Actions.",
    },
    {
      title: "Module 7: Advanced Tools & Concepts",
      details:
        "Use Postman for API testing, implement JWT authentication, apply role-based access with Passport.js, caching with Redis, and secure your applications with best practices.",
    },
    {
      title: "Module 8: Projects",
      details:
        "Build real-world portfolio projects: E-commerce Application, Social Media Platform, Task Management System, and Real-time Chat App with WebSockets.",
    },
    {
    ...
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification in MEAN Stack Development
        </h3>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>MEAN Stack Development</strong> program at{" "}
