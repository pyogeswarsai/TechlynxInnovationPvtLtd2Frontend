...
const faqs = [
  {
    question: "What is a MERN Stack Developer course?",
    answer:
      "This course trains you in full-stack web development using MongoDB, Express.js, React, and Node.js to build modern, scalable applications.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic programming knowledge is useful but not mandatory. The course starts with JavaScript fundamentals and gradually moves into MERN stack concepts.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You will learn HTML, CSS, JavaScript, React for frontend, Node.js & Express.js for backend, MongoDB for databases, REST APIs, and Git/GitHub for version control.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build projects like an E-commerce Application, Social Media Platform, Blogging Website, Task Manager, and Real-time Chat App with WebSockets.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a MERN Stack Developer, Full-Stack Developer, Backend Developer, Frontend Developer, or Web Application Developer in IT companies and startups.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive an industry-recognized certificate validating your MERN stack development skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, most programs include career support such as resume building, interview preparation, and job referrals through hiring partners.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "JavaScript basics, ES6+ features, data types, loops, functions, OOP concepts, asynchronous programming (callbacks, promises, async/await), and problem-solving with mini projects.",
    },
    {
      title: "Module 2: Front-End Development",
      details:
        "Learn HTML, CSS, JavaScript, responsive design with Bootstrap/Tailwind, React.js, React Router, and state management with Redux.",
    },
    {
      title: "Module 3: Back-End Development",
      details:
        "Master Node.js and Express.js, build RESTful APIs with authentication, middleware, CRUD operations, and follow MVC patterns.",
    },
    {
      title: "Module 4: Databases",
      details:
        "Work with MongoDB as a NoSQL database, practice schema design with Mongoose, indexing, aggregation pipelines, and query optimization.",
    },
    {
    ...
    },
    {
      ...
      details:
        "Deploy MERN applications using Docker, Nginx, AWS/Heroku, and set up CI/CD pipelines with GitHub Actions or Jenkins.",
    },
    {
      title: "Module 7: Advanced Tools & Concepts",
      details:
        "Use Postman for API testing, JWT for authentication, Redux for state management, caching with Redis, and WebSockets for real-time apps.",
    },
    {
      title: "Module 8: Projects",
      details:
        "Build real-world portfolio projects: E-commerce Store, Social Media App, Blogging Platform, Task Management App, and Real-time Chat Application.",
    },
    {
    ...
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification in MERN Stack Development
        </h3>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>MERN Stack Development</strong> program at{" "}
