...
const faqs = [
  {
    question: "What is a Java Full-Stack Developer course?",
    answer:
      "This course trains you in both frontend (HTML, CSS, JavaScript, React/Angular) and backend (Java, Spring Boot, Hibernate) development, along with databases and deployment skills.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic knowledge of programming is helpful but not required. The course usually begins with Java fundamentals before advancing to full-stack concepts.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You will learn HTML, CSS, JavaScript, React or Angular for frontend, Java with Spring Boot & Hibernate for backend, REST APIs, MySQL/MongoDB for databases, and Git/GitHub for version control.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build real-world projects like an Employee Management System, E-commerce Store, Online Banking System, Portfolio Website, and RESTful API-based applications.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Java Full-Stack Developer, Backend Developer, Frontend Developer, Web Application Developer, or Software Engineer in IT companies and startups.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive an industry-recognized certificate validating your Java full-stack development skills.",
  },
  {
  ...
  const steps = [
    {
      ...
      details:
        "Java basics, data types, loops, functions, OOP concepts (classes, inheritance, polymorphism), exception handling, and problem-solving with mini exercises.",
    },
    {
      title: "Module 2: Front-End Development",
      details:
        "Learn HTML, CSS, JavaScript, responsive design with Bootstrap/Tailwind, and React.js or Angular for building interactive UIs.",
    },
    {
      title: "Module 3: Back-End Development",
      details:
        "Master Java with Spring & Spring Boot, build RESTful APIs with authentication, perform CRUD operations, and follow MVC architecture.",
    },
    {
      title: "Module 4: Databases",
      details:
        "Work with MySQL/PostgreSQL for SQL, integrate Hibernate/JPA with Spring Boot, and practice joins, indexing, transactions, and optimization.",
    },
    {
      title: "Module 5: Version Control & Collaboration",
      details:
        "Learn Git basics, GitHub/GitLab workflows, branching, merging, pull requests, and collaborative development practices.",
    },
    {
      title: "Module 6: Deployment & DevOps Basics",
      details:
        "Deploy Java applications using Docker, Tomcat, Nginx, AWS/Heroku, and set up CI/CD pipelines with Jenkins or GitHub Actions.",
    },
    {
      title: "Module 7: Advanced Tools & Concepts",
      details:
        "Use Postman for API testing, apply Hibernate for ORM, caching with Redis, JWT for authentication, and Spring Security for authorization.",
    },
    {
      title: "Module 8: Projects",
      details:
        "Build real-world portfolio projects: Employee Management System, E-commerce Store, Online Banking System, and Real-time Chat Application.",
    },
    {
    ...
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification in Full Stack Java Development
        </h3>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>Java Full-Stack Development</strong> program at{" "}
