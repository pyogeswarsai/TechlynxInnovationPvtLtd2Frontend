...
const faqs = [
  {
    question: "What is an AI Full-Stack Developer course?",
    answer:
      "This course trains you in both AI/ML development (Python, TensorFlow, PyTorch, Scikit-learn) and frontend/backend development (HTML, CSS, JavaScript, React), along with databases, APIs, and deployment skills.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic knowledge of Python or programming is helpful but not required. The course begins with Python fundamentals before moving to AI and full-stack concepts.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You will learn Python, TensorFlow, PyTorch, Scikit-learn for AI/ML, HTML, CSS, JavaScript, React for frontend, backend frameworks (Flask/Django), MySQL/MongoDB, and Git/GitHub for version control.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build projects like AI-powered Chatbots, Predictive Analytics Applications, Image Recognition Systems, Recommendation Engines, and Full-Stack AI Web Apps.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as an AI Developer, Machine Learning Engineer, Data Scientist, AI Full-Stack Developer, or Software Engineer in AI/ML-focused companies.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive an industry-recognized certificate validating your AI and full-stack development skills.",
  },
  {
...
function Ai() {
  ...
  const steps = [
    ...
    },
    {
      ...
      details:
        "Work with MySQL/PostgreSQL for SQL, integrate with backend frameworks, and practice joins, indexing, transactions, and optimization.",
    },
    {
      title: "Module 5: AI & Machine Learning",
      details:
        "Learn data preprocessing, supervised & unsupervised learning, neural networks, NLP, and computer vision using TensorFlow and PyTorch.",
    },
    {
      title: "Module 6: AI Project Development",
      details:
        "Implement AI models into web applications, build chatbots, recommendation engines, and deploy AI solutions on cloud platforms.",
    },
    {
    ...
    },
    {
      ...
      details:
        "Deploy AI and web applications using Docker, Nginx, AWS/Heroku, and set up CI/CD pipelines with GitHub Actions or Jenkins.",
    },
    {
      title: "Module 9: Career Preparation",
      details:
        "Prepare for AI & full-stack job interviews with DSA, system design basics, mock interviews, resume building, and communication skills.",
    },
  ];
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>Artificial Intelligence</strong> program at{" "}
