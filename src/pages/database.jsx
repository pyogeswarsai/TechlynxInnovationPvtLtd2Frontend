...
const faqs = [
  {
    question: "What is a Database Administrator (DBA) course?",
    answer:
      "This course trains you to manage, secure, and optimize databases, covering relational and NoSQL systems with practical industry use cases.",
  },
  {
    question: "Do I need programming knowledge?",
    answer:
      "Basic knowledge of SQL is recommended. Familiarity with Python or shell scripting can help in automation, but it’s not mandatory.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You’ll learn MySQL, PostgreSQL, Oracle, SQL Server, MongoDB, Redis, Cassandra, and tools for performance monitoring, backup, and recovery.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll work on projects like database design, replication and backup automation, high availability setup, and real-world query optimization.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Database Administrator, Data Engineer, SQL Developer, Cloud Database Engineer, or Systems Architect.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, you’ll get an industry-recognized certificate validating your DBA skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, it includes resume building, interview prep, and placement support with partner companies.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "Relational databases, NoSQL databases, data models, ER diagrams, and fundamentals of DBMS.",
    },
    {
      title: "Module 2: SQL Fundamentals",
      details:
        "Basic to advanced SQL queries, joins, subqueries, views, triggers, and stored procedures.",
    },
    {
      title: "Module 3: Database Design & Normalization",
      details:
        "Normalization, schema design, indexing strategies, entity-relationship modeling, and constraints.",
    },
    {
      title: "Module 4: Administration & Security",
      details:
        "User management, access control, encryption, auditing, and database hardening techniques.",
    },
    {
      title: "Module 5: Backup & Recovery",
      details:
        "Types of backups, point-in-time recovery, disaster recovery planning, and high availability.",
    },
    {
      title: "Module 6: Performance Tuning & Optimization",
      details:
        "Query optimization, indexing, partitioning, caching, and monitoring performance metrics.",
    },
    {
      title: "Module 7: Advanced Databases & NoSQL",
      details:
        "Hands-on with MongoDB, Redis, Cassandra, and when to choose NoSQL over relational DBs.",
    },
    {
      title: "Module 8: Cloud Databases",
      details:
        "AWS RDS, Azure SQL Database, Google Cloud Spanner, database migration, and scaling.",
    },
    {
      title: "Module 9: Career Preparation",
      details:
        "Certifications (Oracle DBA, MySQL, MongoDB, Microsoft SQL Server), mock interviews, resume prep, and job readiness.",
    },
  ];
  return (
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification in Database Administrator
        </h3>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>Database Administrator</strong> program at{" "}
