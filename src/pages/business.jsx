...
const tools = [
  ...
  { name: "SAS", img: "https://cdn.worldvectorlogo.com/logos/sas-2.svg" },
  { name: "Qlik", img: "https://cdn.worldvectorlogo.com/logos/qlik-1.svg" },
  {
...
const faqs = [
  {
    question: "What is a Business Analyst & Intelligence course?",
    answer:
      "This course equips you with skills in business analysis, data visualization, data-driven decision making, and BI tools to solve organizational problems.",
  },
  {
    question: "Do I need prior technical knowledge?",
    answer:
      "Basic knowledge of Excel and logical thinking is helpful. Programming in Python/SQL is introduced during the course.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You’ll learn Excel, SQL, Tableau, Power BI, Python, R, and tools like Jira for requirements and project management.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build sales dashboards, customer churn analysis, financial forecasting, marketing campaign analysis, and HR analytics reports.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Business Analyst, BI Analyst, Data Analyst, Reporting Analyst, or Strategy Consultant.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive a certificate validating your business analysis and BI skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, it includes career support, resume reviews, mock interviews, and job opportunities with companies in finance, IT, healthcare, and consulting.",
  },
];
...
function BusinessAnalyst() {
  ...
  const steps = [
    {
      title: "Module 1: Business Analysis Fundamentals",
      details:
        "Learn business analysis principles, SDLC, Agile methodologies, requirement gathering, and stakeholder management.",
    },
    {
      title: "Module 2: Data Handling with Excel & SQL",
      details:
        "Master Excel functions, pivot tables, and SQL queries for structured data management.",
    },
    {
      title: "Module 3: Data Visualization & BI Tools",
      details:
        "Hands-on training with Tableau, Power BI, and Google Data Studio for dashboard creation.",
    },
    {
      title: "Module 4: Statistical Analysis & Forecasting",
      details:
        "Use Python/R for descriptive statistics, hypothesis testing, regression, and forecasting models.",
    },
    {
      title: "Module 5: Business Intelligence & Reporting",
      details:
        "Build interactive BI reports, key performance indicators (KPIs), and automated reporting pipelines.",
    },
    {
      title: "Module 6: Domain Knowledge in BA & BI",
      details:
        "Apply BA & BI skills in finance, marketing, operations, HR, and customer analytics use cases.",
    },
    {
      title: "Module 7: Tools for Collaboration & Documentation",
      details:
        "Work with Jira, Confluence, and wireframing tools for requirement documentation and project tracking.",
    },
    {
      title: "Module 8: Case Studies & Capstone Projects",
      details:
        "End-to-end projects like sales performance dashboards, churn analysis, or predictive HR analytics.",
    },
    {
      title: "Module 9: Career Preparation",
      details:
        "Resume building, BA/BI interview prep, case study interviews, and business problem-solving workshops.",
    },
  ];
  return (
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification as Business Analyst & Intelligence
        </h3>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            ...
            <h2 className="fw-bold">
              Advanced Certification in Business Analyst & Intelligence
            </h2>
          ...
          <div className="col-md-6 text-center">
            <img
              src="/analyst.png"
              alt="Business Analyst & intelligence"
          ...
          <div className="col-md-6 px-4">
            <div className="flowchart-scrollable">
              <h2 className="roadmap-heading text-primary fw-bold mb-5 text-center">
                🚀 Business Analyst & Intelligence Roadmap
              </h2>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>Business Analyst & Intelligence</strong> program at{" "}
