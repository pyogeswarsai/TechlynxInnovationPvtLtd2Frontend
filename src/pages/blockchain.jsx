...
const faqs = [
  {
    question: "What is a Blockchain Full-Stack Developer course?",
    answer:
      "This course trains you in blockchain fundamentals, smart contracts, decentralized apps (dApps), and deployment using blockchain platforms.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic programming knowledge in JavaScript or Python is recommended. The course introduces blockchain concepts before advancing to smart contracts and dApps.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You’ll learn Solidity for smart contracts, Ethereum, Hyperledger, Web3.js, Truffle, Ganache, IPFS for storage, and Git/GitHub for collaboration.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll build projects like Token Systems, Voting dApps, Decentralized Finance (DeFi) apps, NFT Marketplaces, and Supply Chain solutions.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Blockchain Developer, Smart Contract Engineer, dApp Developer, Web3 Engineer, or Blockchain Consultant.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive a certificate validating your blockchain development skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, the course includes career support, mock interviews, resume reviews, and job opportunities with blockchain startups and enterprises.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "Introduction to blockchain, distributed ledger, consensus mechanisms (PoW, PoS), and blockchain use cases.",
    },
    {
      title: "Module 2: Cryptography & Smart Contracts",
      details:
        "Hash functions, digital signatures, Solidity programming, and smart contract development.",
    },
    {
      title: "Module 3: Ethereum & dApp Development",
      details:
        "Set up Ethereum blockchain, use Web3.js, build and deploy decentralized applications.",
    },
    {
      title: "Module 4: Tools & Frameworks",
      details:
        "Work with Truffle, Ganache, Metamask, and IPFS for testing, storage, and blockchain interaction.",
    },
    {
      title: "Module 5: Hyperledger & Enterprise Blockchain",
      details:
        "Introduction to Hyperledger Fabric, chaincode development, and enterprise blockchain solutions.",
    },
    {
      title: "Module 6: DeFi & NFTs",
      details:
        "Build decentralized finance apps, understand liquidity pools, and create NFT marketplaces.",
    },
    {
      title: "Module 7: Security in Blockchain",
      details:
        "Smart contract vulnerabilities, secure coding practices, and auditing tools for blockchain security.",
    },
    {
      title: "Module 8: Deployment & Integration",
      details:
        "Deploy blockchain apps on Ethereum testnets, connect with cloud services, and integrate APIs.",
    },
    {
      title: "Module 9: Career Preparation",
      details:
        "Prepare for blockchain developer roles, system design basics, mock interviews, and portfolio building.",
    },
  ];
  return (
    <div>
      ...
      <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
        <h3 className="fw-bold display-5">
          Advanced Certification in Blockchain Technology
        </h3>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>Blockchain Technology</strong> program at{" "}
      ...
      <section className="course-fees-container container my-5 p-4 shadow rounded bg-color">
        ...
        <p className="course-fee text-center fw-boldfw-bold">
          💰 The course fee is <span className="highlight">₹59,999</span> + GST
        </p>
        <hr />
