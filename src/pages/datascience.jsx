...
const faqs = [
  {
    ...
    answer:
      "This course trains you to analyze data, build predictive models, visualize insights, and apply machine learning to solve real-world business problems.",
  },
  {
    question: "Do I need prior programming knowledge?",
    answer:
      "Basic knowledge of Python, statistics, and SQL is recommended, but beginners can start with foundational modules included in the course.",
  },
  {
    question: "What technologies will I learn?",
    answer:
      "You’ll learn Python, R, Pandas, NumPy, Matplotlib, Scikit-Learn, TensorFlow, PyTorch, SQL, and visualization tools like Tableau.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "Projects include Customer Churn Prediction, Sales Forecasting, Image Classification, Sentiment Analysis, and Business Dashboards.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Data Scientist, Machine Learning Engineer, Business Analyst, Data Engineer, or AI Specialist.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, you’ll receive an industry-recognized certificate validating your data science and AI skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, you’ll get resume building, interview preparation, and placement opportunities with hiring partners.",
  },
];
  ...
  const steps = [
    {
      ...
      details:
        "Overview of data science, workflow, applications across industries, and data-driven decision making.",
    },
    {
      title: "Module 2: Python, R & SQL for Data Science",
      details:
        "Hands-on programming in Python, R, and SQL queries for data extraction and preprocessing.",
    },
    {
      title: "Module 3: Data Wrangling & Exploration",
      details:
        "Work with Pandas and NumPy to clean, transform, and analyze datasets.",
    },
    {
      title: "Module 4: Data Visualization",
      details:
        "Visualize data using Matplotlib, Seaborn, and Tableau to generate business insights.",
    },
    {
      title: "Module 5: Statistics & Probability",
      details:
        "Statistical inference, hypothesis testing, distributions, and data sampling methods.",
    },
    {
      title: "Module 6: Machine Learning Foundations",
      details:
        "Supervised and unsupervised learning, regression, classification, clustering, and Scikit-Learn implementation.",
    },
    {
      title: "Module 7: Deep Learning & AI",
      details:
        "Neural networks with TensorFlow and PyTorch, CNNs for image processing, RNNs for sequence data.",
    },
    {
      title: "Module 8: Big Data & Cloud Integration",
      details:
        "Working with Spark, Hadoop basics, and deploying ML models on AWS, GCP, or Azure.",
    },
    {
      title: "Module 9: Capstone Project & Career Prep",
      details:
        "End-to-end real-world project, portfolio building, interview prep, and certification readiness.",
    },
  ];
  return (
    <div>
      ...
      <div className="container my-5">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            ...
            <h2 className="fw-bold">Advanced Certification in Data Science</h2>
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 mb-4">
            <div className="certificate-card p-4 rounded shadow-lg">
              ...
              <h5 className="mt-4 text-success fw-bold">Data Science</h5>
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              Upon successful completion of our <strong>Data Science</strong>{" "}
      ...
      <section className="course-fees-container container my-5 p-4 shadow rounded bg-color">
        ...
        <p className="course-fee text-center fw-boldfw-bold">
          💰 The course fee is <span className="highlight">₹69,999</span> + GST
        </p>
        <hr />
